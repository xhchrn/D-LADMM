...
if __name__ == "__main__":
    ...
    # cosine
    cosine_train = np.cos(gaus_train)
    cosine_test = np.cos(gaus_test)
    # z = bernoulli * gaussian
    train_z = bern_train * cosine_train
    test_z = bern_test * cosine_test
    ...
    train_e = bern_train * cosine_train
    test_e = bern_test * cosine_test
    ...
    d = dict(A       = A,
             ...
             test_e  = test_e)
    # save mat file
    sio.savemat('syn_data_p{}_mu{}_s{}_cosine.mat'.format(p, mu, sigma), d)
